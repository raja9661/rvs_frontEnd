...
// import { Search, Save, Plus, Edit, Trash2, X, ChevronLeft, ChevronRight } from "lucide-react";
...
//         }
//       );
//       alert("Vendor-Product combinations saved successfully!");
//       setNewVendorName("");
//       setSelectedProducts([]);
//       fetchVendorProducts();
//     } catch (err) {
...
//   // Handle delete vendor-product combination
//   const handleDelete = async (id) => {
//     if (window.confirm("Delete this vendor-product combination?")) {
//       setLoading(true);
//       try {
//         await axios.delete(
//           `${import.meta.env.VITE_Backend_Base_URL}/mapping/deleteVendorProducts/${id}`
//         );
//         fetchVendorProducts();
...
//         } rounded-lg p-4 md:p-6 shadow-xl`}>
...
//               }`}>Manage vendor and product relationships</p>
//             </div>
//           </div>
//         </div> */}
