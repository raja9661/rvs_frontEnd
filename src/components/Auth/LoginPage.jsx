...
// import Business from "../../assets/bussiness-img.svg"
...
//   return (
//     <div className="h-screen w-full flex items-center justify-center bg-gradient-to-br from-cyan-700 to-blue-900 relative overflow-hidden">
//       {/* Hexagon Pattern Background */}
//       <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/hexellence.png')] opacity-20"></div>

//       {/* Glassmorphism Card */}
//       <div className="relative z-10 bg-white/20 backdrop-blur-lg p-8 rounded-2xl shadow-lg w-96">
...
//                 className="w-full pl-10 p-3 rounded-lg bg-white/10 text-gray-100 border border-white/20 focus:outline-none focus:ring-2 focus:ring-cyan-400"
...
//             type="submit"
//             disabled={loading}
//             className={`w-full py-3 rounded-lg bg-gradient-to-r from-purple-500 to-orange-400 text-white font-semibold tracking-wider hover:scale-105 transition-transform ${
