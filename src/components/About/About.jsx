...
// import "slick-carousel/slick/slick-theme.css";
// import FadeInOnScroll from './FadeInOnScroll';
// import { FaArrowLeft, FaArrowRight, FaTimes } from "react-icons/fa"; // You can use any icons
...
//                                   Nationalized Banks: SBI, PNB, Indian Bank, UCO Bank, and 
//                                   <div className="relative inline-block left-1.5" ref={dropdownRef1}>
//                                     <button
//                                       onClick={() =>
//                                         setOpenDropdown(openDropdown === 'others' ? null : 'others')
//                                       }
//                                       className="text-blue-400 hover:text-blue-600 hover:underline focus:outline-none cursor-pointer"
//                                     >others </button>

//                                     {openDropdown === 'others' && (
//                                       <div className="absolute z-10 mt-2 w-56 bg-white shadow-lg border border-gray-200 rounded-md">
...
//                                           <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">Bank of Baroda</li>
//                                           <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">Canara Bank</li>
//                                           <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">PNB</li>
//                                         </ul>
//                                       </div>
//                                     )}
//                                   </div>
...
//                                 <li>Private Sector Banks: HDFC, ICICI, Axis, IDBI, Citibank, and
//                                   <div className="relative inline-block left-1.5" ref={dropdownRef2}>
//                                     <button
//                                       onClick={() =>
...
//                                         </div>
//                                         <ul className="py-1 text-gray-700">
//                                           <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">HSBC</li>
//                                           <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">Standard Chartered</li>
//                                           <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">DBS Bank</li>
//                                         </ul>
//                                       </div>
//                                     )}
//                                   </div>
...
// Drop Down start from here
  ...
  <div className="relative">
    Nationalized Banks: SBI, PNB, Indian Bank, UCO Bank, and
    <div className="inline-block left-1.5" ref={dropdownRef1}>
      {!openDropdown || openDropdown !== 'others' ? (
        <button
          onClick={() => setOpenDropdown('others')}
          className="text-blue-400 hover:text-blue-600 hover:underline focus:outline-none cursor-pointer ml-1"
        >
          others
        </button>
      ) : (
...
<li className="text-white">
  Private Sector Banks: HDFC, ICICI, Axis, IDBI, Citibank,
  <div className="relative inline-block left-1.5" ref={dropdownRef2}>
    {!openDropdown ? (
      <button
      ...
      <div className="mt-2 ml-4 transition-all duration-300">
        <div className="text-white">
          HSBC, Standard Chartered, DBS Bank,HSBC, Standard Chartered, DBS Bank
          <button
            onClick={() => setOpenDropdown(null)}
            className="text-blue-400 hover:text-blue-600 hover:underline focus:outline-none cursor-pointer ml-1"
          >
