...
// import { Edit, Trash2, Search, CheckSquare, UserPlus, Users } from "lucide-react";
...
//       .catch((error) => console.error("Error fetching assigned employees:", error));
//   };
...
//       })
//       .then(() => {
//         alert("Access assigned/updated successfully!");
//         setSelectedEmployee("");
//         setEditableColumns([]);
//         // Refresh assigned employees list
//         fetchAssignedEmployees();
//       })
//       .catch((error) => console.error("Failed to assign/update access:", error));
//   };
...
//         fetchAssignedEmployees();
//       })
//       .catch((error) => console.error("Failed to update access:", error));
//   };

//   const handleDeleteAccess = (employeeName) => {
//     const confirmDelete = window.confirm(`Are you sure you want to delete access for ${employeeName}?`);
//     if (confirmDelete) {
//       axios
//         .delete(`${import.meta.env.VITE_Backend_Base_URL}/access/delete-access/${employeeName}`)
//         .then(() => {
//           alert("Employee access deleted successfully!");
//           // Refresh assigned employees list
//           fetchAssignedEmployees();
//         })
//         .catch((error) => console.error("Failed to delete access:", error));
//     }
//   };
...
//               }`}>Employee Access Manager</h2>
//               <p className={`mt-2 ${
//                 isDarkMode ? 'text-gray-400' : 'text-gray-600'
//               }`}>Configure and manage column-level access permissions</p>
//             </div>
...
//                           </button>
//                           <button
//                             onClick={() => handleDeleteAccess(employee.employeeName)}
//                             className={`p-2 rounded-full ${
//                               isDarkMode 
